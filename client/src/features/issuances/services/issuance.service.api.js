/**
 * Issuance Service — Backend API Implementation
 *
 * Calls real /api/issuances and /api/admin/issuances endpoints.
 * Used when DATA_SOURCE === "api".
 */
import api from "../../../services/api";
import { ENDPOINTS } from "../../../config";

export const issuanceServiceAPI = {
    // ================================================================
...
/**
 * Comment Service — Backend API Implementation
 */
